...
namespace KCC
{
    public interface ICharacterController
    {
        ...
        /// </summary>
        bool IsColliderValidForCollisions(Collider col);
        /// <summary>
        /// This is called when the motor's ground probing detects a ground hit
        /// </summary>
        void OnGroundHit(Collider hitCollider, in Vector3 hitNormal, 
            in Vector3 hitPoint, ref HitStabilityReport hitStabilityReport);
        /// <summary>
        /// This is called when the motor's movement logic detects a hit
        /// </summary>
        void OnMovementHit(Collider hitCollider, in Vector3 hitNormal, 
            in Vector3 hitPoint, ref HitStabilityReport hitStabilityReport);
        /// <summary>
        /// This is called after every move hit, to give you an opportunity to modify the HitStabilityReport to your liking
        /// </summary>
        void ProcessHitStabilityReport(Collider hitCollider, in Vector3 hitNormal, in Vector3 hitPoint, 
